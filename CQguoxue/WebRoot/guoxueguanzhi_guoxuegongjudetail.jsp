...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "select * from guoxueguanzhi_guoxuegongju where number='" +number+ "'";
  	     ...
  	     try
  	     {
		        ...
		        if(session.getAttribute(number) == null)
		        {
		        	...
		        	visits2 = visits;
		        	visits2++;
		        	String sql1 = "update guoxueguanzhi_guoxuegongju set visits = "+visits2+" where number='"+number+"'";
...
<body>
		<div id="container" class="sub-container"> 
                ...
                <div id="pagebody">
                		<div id="mainbody"> 
                        	<div>当前位置: <a href="chongqingguoxue.jsp">首页</a> > <a href="guoxueguanzhi_guoxuegongju.jsp">国学工具</a> > 正文</div>
                            <div>
