...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "select * from guoxueguanzhi_guoxuerenwu where number='" +number+ "'";
  	     ...
  	     try
  	     {
		        ...
		        if(session.getAttribute(number) == null)
		        {
		        	...
		        	visits2 = visits;
		        	visits2++;
		        	String sql1 = "update guoxueguanzhi_guoxuerenwu set visits = "+visits2+" where number='"+number+"'";
...
<body>
		<div id="container" class="sub-container"> 
                ...
                <div id="pagebody">
                		<div id="mainbody"> 
                        	<div>当前位置: <a href="chongqingguoxue.jsp">首页</a> > <a href="guoxueguanzhi_guoxuerenwu.jsp">国学人物</a> > 正文</div>
                            <div>
