...
<% 
		 ...
		 Connection conn = null; 	    
  	     ...
  	     String sql2 = "select * from xueyuan_xinwen";
...
<body>
		<div id="container" class="sub-container"> 
                ...
                <div id="pagebody">
                		<div id="mainbody"> 
                        	<div >当前位置: <a href="chongqingguoxue.jsp">首页</a> > 学院新闻</div>
                        	<br>
                            <div id="table_list">
                            		<div style=" font-size:28px;"><p>学院新闻列表</p></div>
                            		<br>
                            		<div style="">
                            		<table style="text-align:left; line-height:30px; align:center;margin:0px auto; font-size:11pt;">
                            			<tr style="height:50px;">
                            				<td style="width:80%; text-align:center; font-size:12pt;">标题</td>                       
                            				<td style="width:30%; text-align:center; font-size:12pt;">发布时间</td>
                            			</tr>
                            			...
                            			%>
                            			<tr>
                            				<td><img src="pictures/other_small.png" />&nbsp;<a href="xueyuan_xinwendetail.jsp?id=<%=rs.getString("number")%>"><%=rs.getString("title") %></a></td>                           				
                            				<td><%=rs.getString("time").substring(0, rs.getString("time").indexOf(" ")) %></td>
                            			</tr>
                            			<% 
                            						rs.next();
                            						i++;
                            		...
                            		<% 
                            			...
                            			{
                            		%>
                            		<a href="xueyuan_xinwen.jsp?page=<%=intPage-1%>">上一页</a>
                            		<% 
                            			}
                            			else if(intPage == 1)
                            			{
                            		...
                            		<% 
                            			...
                            			{
                            		%>
                            		<a href="xueyuan_xinwen.jsp?page=<%=intPage+1%>">下一页</a>
                            		<% 
                            			}
                		...
                		<div id="sidebar"> 
                        	<div>
                        		<div style="font-size:20px; border-bottom: 1px solid #ffffff; ">热门文章</div>
                            	...
                            	<ul>
                                        	...
                                        	<% 
                                    			...
                                    			{
                                    		%>
                                        	<li><a href="xueyuan_xinwendetail.jsp?id=<%=number1 %>"><%=title1 %></a></li>
                                        	<% 
                                        		}
                                        	%>
                                        	...
                                        	<% 
                                    			...
                                    			{
                                    		%>
                                        	<li><a href="xueyuan_xinwendetail.jsp?id=<%=number2 %>"><%=title2 %></a></li>
                                        	<% 
                                        		}
                                        	%>
                                        	...
                                        	<% 
                                    			...
                                    			{
                                    		%>
                                        	<li><a href="xueyuan_xinwendetail.jsp?id=<%=number3 %>"><%=title3 %></a></li>
                                        	<% 
                                        		}
                                        	%>
                                        	...
                                        	<% 
                                    			...
                                    			{
                                    		%>
                                        	<li><a href="xueyuan_xinwendetail.jsp?id=<%=number4 %>"><%=title4 %></a></li>
                                        	<% 
                                        		}
                                        	%>
                                        	...
                                        	<% 
                                    			...
                                    			{
                                    		%>
                                        	<li><a href="xueyuan_xinwendetail.jsp?id=<%=number5 %>"><%=title5 %></a></li>
                                        	<% 
                                        		}
                                        	%>
