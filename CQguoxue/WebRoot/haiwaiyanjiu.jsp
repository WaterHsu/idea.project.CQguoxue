...
<% 
		 ...
		 Connection conn = null; 	    
   	     String sql = "select * from guoxueyanjiu_haiwaiyanjiu order by id desc";
  	     PreparedStatement statement = null;
  	     ResultSet rs = null;
  	     
  	     
  	     String sql2 = "select * from guoxueyanjiu_haiwaiyanjiu";
...
<body>
		<div id="container" class="sub-container"> 
                ...
                <div id="pagebody">
                		<div id="mainbody"> 
                        	<div>当前位置: <a href="chongqingguoxue.jsp">首页</a>  海外研究</div>
                            <div id="table_list">
                            		<h2>海外研究文章列表</h2>
                            		<table style="text-align:center; line-height:30px; align:center;margin:0px auto;">
                            			...
                            			%>
                            			<tr>
                            				<td><a href="haiwaiyanjiudetail.jsp?id=<%=rs.getString("number")%>"><%=rs.getString("title") %></a></td>
                            		...
                            		<% 
                            			...
                            			{
                            		%>
                            		<a href="haiwaiyanjiu.jsp?page=<%=intPage-1%>">上一页</a>
                            		<% 
                            			}
                            			else if(intPage == 1)
                            			{
                            		...
                            		<% 
                            			...
                            			{
                            		%>
                            		<a href="haiwaiyanjiu.jsp?page=<%=intPage+1%>">下一页</a>
                            		<% 
                            			}
                                    ...
                                    <li>
                                    	<ul>
                                        	<% 
                                    			...
                                    			{
                                    		%>
                                        	<li><a href="haiwaiyanjiudetail.jsp?id=<%=number1 %>"><%=title1 %></a></li>
                                        	<% 
                                        		}
                                        	%>
                                        	...
                                        	<% 
                                    			...
                                    			{
                                    		%>
                                        	<li><a href="haiwaiyanjiudetail.jsp?id=<%=number2 %>"><%=title2 %></a></li>
                                        	<% 
                                        		}
                                        	%>
                                        	...
                                        	<% 
                                    			...
                                    			{
                                    		%>
                                        	<li><a href="haiwaiyanjiudetail.jsp?id=<%=number3 %>"><%=title3 %></a></li>
                                        	<% 
                                        		}
                                        	%>
                                        	...
                                        	<% 
                                    			...
                                    			{
                                    		%>
                                        	<li><a href="haiwaiyanjiudetail.jsp?id=<%=number4 %>"><%=title4 %></a></li>
                                        	<% 
                                        		}
                                        	%>
                                        	...
                                        	<% 
                                    			...
                                    			{
                                    		%>
                                        	<li><a href="haiwaiyanjiudetail.jsp?id=<%=number5 %>"><%=title5 %></a></li>
                                        	<% 
                                        		}
                                        	%>
                                        </ul>
