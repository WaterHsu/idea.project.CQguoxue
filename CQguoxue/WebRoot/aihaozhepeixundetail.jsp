...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "select * from guoxuepeixun_aihaozhepeixun where number='" +number+ "'";
  	     ...
  	     try
  	     {
		        ...
		        if(session.getAttribute(number) == null)
		        {
		        	...
		        	visits2 = visits;
		        	visits2++;
		        	String sql1 = "update guoxuepeixun_aihaozhepeixun set visits = "+visits2+" where number='"+number+"'";
...
<body>
		<div id="container" class="sub-container"> 
                ...
                <div id="pagebody">
                		<div id="mainbody"> 
                        	<div>当前位置: <a href="chongqingguoxue.jsp">首页</a> > <a href="aihaozhepeixun.jsp">爱好者培训</a> > 正文</div>
                            <div>
