...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "select * from xueyuan_xinwen where number='" +number+ "'";
  	     ...
  	     try
  	     {
		        ...
		        if(session.getAttribute(number) == null)
		        {
		        	...
		        	visits2 = visits;
		        	visits2++;
		        	String sql1 = "update xueyuan_xinwen set visits = "+visits2+" where number='"+number+"'";
...
<body>
		<div id="container" class="sub-container"> 
                ...
                <div id="pagebody">
                		<div id="mainbody"> 
                        	<div>当前位置: <a href="chongqingguoxue.jsp">首页</a> > <a href="xueyuan_xinwen.jsp">学院新闻</a> > 正文</div>
                        	<br>
                            <div>
                            	<div style="">
                            		<div style="text-align:center; font:30px Tahoma; margin:0px auto;"><%=title %></div>
                            		<div style="margin:0px auto; border-bottom:1px solid #ffffff;">
