...
<% 
		 ...
		 Connection conn = null; 	    
   	     String sql = "select * from guoxuepeixun_gongwuyuanpeixun order by id desc";
  	     PreparedStatement statement = null;
  	     ResultSet rs = null;
  	     
  	     
  	     String sql2 = "select * from guoxuepeixun_gongwuyuanpeixun";
...
<body>
		<div id="container" class="sub-container"> 
                ...
                <div id="pagebody">
                		<div id="mainbody"> 
                        	<div>当前位置: <a href="chongqingguoxue.jsp">首页</a> > 公务员培训</div>
                            <div id="table_list">
                            		<h2>公务员培训文章列表</h2>
                            		<table style="text-align:center; line-height:30px; align:center;margin:0px auto;">
                            			...
                            			%>
                            			<tr>
                            				<td><a href="gongwuyuanpeixundetail.jsp?id=<%=rs.getString("number")%>"><%=rs.getString("title") %></a></td>
                            		...
                            		<% 
                            			...
                            			{
                            		%>
                            		<a href="gongwuyuanpeixun.jsp?page=<%=intPage-1%>">上一页</a>
                            		<% 
                            			}
                            			else if(intPage == 1)
                            			{
                            		...
                            		<% 
                            			...
                            			{
                            		%>
                            		<a href="gongwuyuanpeixun.jsp?page=<%=intPage+1%>">下一页</a>
                            		<% 
                            			}
                                    ...
                                    <li>
                                    	<ul>
                                        	<% 
                                    			...
                                    			{
                                    		%>
                                        	<li><a href="gongwuyuanpeixundetail.jsp?id=<%=number1 %>"><%=title1 %></a></li>
                                        	<% 
                                        		}
                                        	%>
                                        	...
                                        	<% 
                                    			...
                                    			{
                                    		%>
                                        	<li><a href="gongwuyuanpeixundetail.jsp?id=<%=number2 %>"><%=title2 %></a></li>
                                        	<% 
                                        		}
                                        	%>
                                        	...
                                        	<% 
                                    			...
                                    			{
                                    		%>
                                        	<li><a href="gongwuyuanpeixundetail.jsp?id=<%=number3 %>"><%=title3 %></a></li>
                                        	<% 
                                        		}
                                        	%>
                                        	...
                                        	<% 
                                    			...
                                    			{
                                    		%>
                                        	<li><a href="gongwuyuanpeixundetail.jsp?id=<%=number4 %>"><%=title4 %></a></li>
                                        	<% 
                                        		}
                                        	%>
                                        	...
                                        	<% 
                                    			...
                                    			{
                                    		%>
                                        	<li><a href="gongwuyuanpeixundetail.jsp?id=<%=number5 %>"><%=title5 %></a></li>
                                        	<% 
                                        		}
                                        	%>
                                        </ul>
