...
<script>
	...
	{		
	//	alert(record_div);
	/*	var div_pre = document.getElementById('show_text1');
		div_pre.style.display="none";
		alert(div_pre.style.display);
		var div = document.getElementById(div_now);
		div.style.display="";
		record_div = div_now;*/
		...
		<div id="container" class="sub-container"> 
                ...
                <div id="pagebody">
                		...
                		<div id="other_sidebar"> 
                    			<ul>
        							<li style="font-height:11pt;">------机构设置------</li>
            						<li>
            							<ul>
                							<li><a href="javascript:void(0);" onclick="ff(1)" class="button next">学院介绍</a></li>
                    						<li><a href="javascript:void(0);" onclick="ff(2)" class="button next">办公室</a></li>
                    						<li><a href="javascript:void(0);" onclick="ff(3)" class="button next">研究部</a></li>
                    						<li><a href="javascript:void(0);" onclick="ff(4)" class="button next">推广部</a></li>
                    						<li><a href="javascript:void(0);" onclick="ff(5)" class="button next">培训部</a></li>
                						</ul>
            						</li>
        						</ul>
                        </div>
