...
<% 		 		 
		 ...
		 Connection conn = null;
   	     String sql1 = "update guoxuejiaoyu_xuelijiaoyu set title = '"+title+"' where number='"+number+"'";
   	     String sql2 = "update guoxuejiaoyu_xuelijiaoyu set author = '"+author+"' where number='"+number+"'";
   	     String sql3 = "update guoxuejiaoyu_xuelijiaoyu set text = '"+text+"' where number='"+number+"'";
   	     String sql4 = "update guoxuejiaoyu_xuelijiaoyu set tiyao = '"+tiyao+"' where number='"+number+"'";
		 ...
		 String log_caozuo = null;
  	     ...
  	     try
  	     {
				...
				statement1 = conn.prepareStatement(sql1);
		 	    ...
		 	    log_caozuo = "在国学教育版块学历教育栏目修改文章:" + title;
		 	  ...
		 	  //  session.setAttribute("guoxuejiaoyu_xuelijiaoyu_message","alter_success");
