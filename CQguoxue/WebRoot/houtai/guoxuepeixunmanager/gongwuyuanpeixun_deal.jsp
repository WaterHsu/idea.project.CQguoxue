...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "delete from guoxuepeixun_gongwuyuanpeixun where number = '" + number +"'";
  	     ...
  	     ResultSet rs = null;
  	      ...
  	      String sql_title = "select * from guoxuepeixun_gongwuyuanpeixun where number = '" + number +"'";
		       ...
		       // statement = conn.prepareStatement(sql);
		        ...
		        if(submit.equals("删除"))
		        {
		        	 statement = conn.prepareStatement(sql);
		 	    	 ...
		 	    	 log_caozuo = "在国学培训版块公务员培训栏目删除文章:" + title;
		 	    	 ...
		 	    	 session.setAttribute("guoxuepeixun_gongwuyuanpeixun_message","delete_success");
		 			 response.sendRedirect("gongwuyuanpeixun.jsp");
		        }
		        else if(submit.equals("修改"))
		        {
		        	String sql2 = "select * from guoxuepeixun_gongwuyuanpeixun where number = '" + number +"'";
...
<html>
  ...
  <body>
  		<div>
  			<a href="houtai/guoxuepeixunmanager/gongwuyuanpeixun.jsp">返回</a>
  		</div>
  			<br><br><br><br>
		...
		<div>
			<h2>修改文章</h2>
			<form  method="post" action="houtai/guoxuepeixunmanager/gongwuyuanpeixun_alter.jsp">
			<% 
				while(rs.next())
				{
			%>
