...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "delete from guoxuepeixun_peixunchengguo where number = '" + number +"'";
  	     ...
  	     String sql_title = "select * from guoxuepeixun_peixunchengguo where number = '" + number +"'";
		       ...
		       // statement = conn.prepareStatement(sql);
		        ...
		        if(submit.equals("删除"))
		        {
		        	 statement = conn.prepareStatement(sql);
		 	    	 ...
		 	    	 log_caozuo = "在国学培训版块培训成果栏目删除文章:" + title;
		 	    ...
		 	    //	 session.setAttribute("guoxuepeixun_peixunchengguo_message","delete_success");
		 			 response.sendRedirect("peixunchengguo.jsp");
		        }
		        else if(submit.equals("修改"))
		        {
		        	String sql2 = "select * from guoxuepeixun_peixunchengguo where number = '" + number +"'";
...
<html>
  ...
  <body>
  		...
  		<div>
  			<a href="houtai/guoxuepeixunmanager/peixunchengguo.jsp">返回</a>
  		</div>
  			<br><br><br><br>
  
		<div>
			<h2>修改文章</h2>
			<form  method="post" action="houtai/guoxuepeixunmanager/peixunchengguo_alter.jsp">
			<% 
				while(rs.next())
				{
			%>
