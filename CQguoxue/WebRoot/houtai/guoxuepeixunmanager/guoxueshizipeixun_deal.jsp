...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "delete from guoxuepeixun_guoxueshizipeixun where number = '" + number +"'";
  	     ...
  	     String sql_title = "select * from guoxuepeixun_guoxueshizipeixun where number = '" + number +"'";
		       ...
		       // statement = conn.prepareStatement(sql);
		        ...
		        if(submit.equals("删除"))
		        {
		        	 statement = conn.prepareStatement(sql);
		 	    	 ...
		 	    	 log_caozuo = "在国学培训版块国学师资培训栏目删除文章:" + title;
		 	    	 ...
		 	    	 session.setAttribute("guoxuepeixun_guoxueshizipeixun_message","delete_success");
		 			 response.sendRedirect("guoxueshizipeixun.jsp");
		        }
		        else if(submit.equals("修改"))
		        {
		        	String sql2 = "select * from guoxuepeixun_guoxueshizipeixun where number = '" + number +"'";
...
<html>
  ...
  <body>
  		<div>
  			<a href="houtai/guoxuepeixunmanager/guoxueshizipeixun.jsp">返回</a>
  		</div>
  			<br><br><br><br>
  
		<div>
			<h2>修改文章</h2>
			<form  method="post" action="houtai/guoxuepeixunmanager/guoxueshizipeixun_alter.jsp">
			<% 
				while(rs.next())
				{
			%>
