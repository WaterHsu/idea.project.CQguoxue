...
<% 		 		 
		 ...
		 Connection conn = null;
   	     String sql1 = "update guoxuepeixun_qishiyeguanliganbupeixun set title = '"+title+"' where number='"+number+"'";
   	     String sql2 = "update guoxuepeixun_qishiyeguanliganbupeixun set author = '"+author+"' where number='"+number+"'";
   	     String sql3 = "update guoxuepeixun_qishiyeguanliganbupeixun set text = '"+text+"' where number='"+number+"'";
   	     String sql4 = "update guoxuepeixun_qishiyeguanliganbupeixun set tiyao = '"+tiyao+"' where number='"+number+"'";
		 ...
		 String log_caozuo = null;
  	     ...
  	     try
  	     {
				...
				statement1 = conn.prepareStatement(sql1);
		 	    ...
		 	    log_caozuo = "在国学培训版块企事业管理干部培训栏目修改文章:" + title;
				...
				log_statement2.executeUpdate(log_sql2);
		 	    ...
		 	    session.setAttribute("guoxuepeixun_qishiyeguanliganbupeixun_message","alter_success");
