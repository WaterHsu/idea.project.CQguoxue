...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "delete from other_quweiguoxue where number = '" + number +"'";
  	     ...
  	     String sql_title = "select * from other_quweiguoxue where number = '" + number +"'";
  	     ...
  	     try
  	     {
		       ...
		       // statement = conn.prepareStatement(sql);
		        ...
		        if(submit.equals("删除"))
		        {
		 	    ...
		 	    //	 session.setAttribute("other_quweiguoxue_message","delete_success");
		 			 response.sendRedirect("quweiguoxue.jsp");
		        }
		        else if(submit.equals("修改"))
		        {
		        	String sql2 = "select * from other_quweiguoxue where number = '" + number +"'";
...
<html>
  ...
  <body>
  		<div>
  			<a href="houtai/othermanager/quweiguoxue.jsp">返回</a>
  		</div>
  			<br><br><br><br>
		...
		<div>
			<h2>修改文章</h2>
			<form  method="post" action="houtai/othermanager/quweiguoxue_alter.jsp">
			<% 
				while(rs.next())
				{
			%>
