...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "select * from other_youqinglianjie";
		 ...
		 String log_caozuo = null;
  	     ...
  	     try
  	     {
		        ...
		        if(mark == 1)
		        {
		        	 session.setAttribute("other_youqinglianjie_message","add_fault");
		        ...
		        else if(mark == 0)
		        {
		        	...
		        	String sql2 = "insert into other_youqinglianjie (id,name,url,add_user) values(" +id+ ",'" +name+ "','" +url+ "','"+houtai_username+"')";
		       		
		       		statement2 = conn.prepareStatement(sql2);
		       		statement2.executeUpdate(sql2);
		       		
		       		
		       		log_caozuo = "添加了友情链接:" +name+ "网址： "+url ;
					...
					log_statement2.executeUpdate(log_sql2);
		       		...
		       		session.setAttribute("other_youqinglianjie_message","add_success");
		       		response.sendRedirect("youqinglianjie.jsp");
		        }
