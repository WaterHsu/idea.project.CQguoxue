  ...
  <body>
		<div>
			...
			<table border=3>
				...
				%>
				<tr>
					<form method="post" action="houtai/othermanager/quweiguoxue_deal.jsp">
						<td><%=rs.getString("time_yearmonthday")%>&nbsp; <%=rs.getString("time_hourminute") %></td>
						<td><a href="quweiguoxuedetail.jsp?id=<%=rs.getString("number")%>" target="_top"><%=rs.getString("title") %></a></td>
		...
		<div>
			<h2>发布文章</h2>
			<form  method="post" action="houtai/othermanager/quweiguoxue_add.jsp">
				<table>
					<tr>
						<td>文章标题:</td>
