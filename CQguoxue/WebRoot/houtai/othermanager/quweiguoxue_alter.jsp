...
<% 		 		 
		 ...
		 Connection conn = null;
   	     String sql1 = "update other_quweiguoxue set title = '"+title+"' where number='"+number+"'";
   	     String sql2 = "update other_quweiguoxue set author = '"+author+"' where number='"+number+"'";
   	     String sql3 = "update other_quweiguoxue set text = '"+text+"' where number='"+number+"'";
   	     String sql4 = "update other_quweiguoxue set tiyao = '"+tiyao+"' where number='"+number+"'";
		 ...
		 String log_caozuo = null;
  	     ...
  	     try
  	     {
		 	   ...
		 	   // session.setAttribute("other_quweiguoxue_message","alter_success");
