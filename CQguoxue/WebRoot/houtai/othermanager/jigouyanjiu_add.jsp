...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "select * from xueyuanjigou_shezhi order by id desc";
		 ...
		 String log_caozuo = null;
  	     ...
  	     try
  	     {
		        ...
		        String sql2 = "insert into xueyuanjigou_shezhi (id,name,leibie,jieshao,time_yearmonth,time_hourminutes,houtai_user) values(" +id+ ",'" +name+ "','" +leibie+ "','" +content+ "','" +time_yearmonthday+ "','" +time_hourminute+ "','" +houtai_username+ "')";
		        
		        statement2 = conn.prepareStatement(sql2);
		       	statement2.executeUpdate(sql2);
		       	
		       	
		       	log_caozuo = "在行政机构/研究单位该板块添加类别是" +leibie+ "的" +name+ "";
