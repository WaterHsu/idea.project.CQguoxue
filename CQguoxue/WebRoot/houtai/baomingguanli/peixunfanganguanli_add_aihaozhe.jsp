...
<% 		 		 
		 ...
		 Connection conn = null;
   	     String sql = "select * from peixunfangan_aihaozhe order by id desc";
		 ...
		 String log_caozuo = null;
  	     ...
  	     try
  	     {
		        ...
		        String sql2 = "insert into peixunfangan_aihaozhe (id,course_name,course_teacher,course_kaike_time,course_place,course_cishu,course_shangke_time) values(" +id+ ",'" +course_name+ "','" +course_teacher+ "','" +course_kaike_time+ "','" +course_place+ "','" +course_cishu+ "','" +course_shangke_time+ "')";
	
  	            statement2 = conn.prepareStatement(sql2);
		       	statement2.executeUpdate(sql2);
		       	
		       		log_caozuo = "在爱好者培训方案里添加了课程:" +course_name+";授课老师：" +course_teacher;
