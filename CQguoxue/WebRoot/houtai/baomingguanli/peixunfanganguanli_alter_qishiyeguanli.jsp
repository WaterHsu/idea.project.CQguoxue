...
<% 
		...
		String idd = request.getParameter("id").toString();
		 ...
		 Connection conn = null;
   	     String sql = "delete from peixunfangan_qishiyeguanli where id = " + id +"";
   	     
   	      String sql2 = "update peixunfangan_qishiyeguanli set course_name = '"+course_name+"' where id="+id+"";
   	      String sql3 = "update peixunfangan_qishiyeguanli set course_teacher = '"+course_teacher+"' where id="+id+"";
   	      String sql4 = "update peixunfangan_qishiyeguanli set course_kaike_time = '"+course_kaike_time+"' where id="+id+"";
   	      String sql5 = "update peixunfangan_qishiyeguanli set course_place = '"+course_place+"' where id="+id+"";
   	      String sql6 = "update peixunfangan_qishiyeguanli set course_cishu = '"+course_cishu+"' where id="+id+"";
   	      String sql7 = "update peixunfangan_qishiyeguanli set course_shangke_time = '"+course_shangke_time+"' where id="+id+"";
  	     ...
  	     try
  	     {
		        ...
		        if(submit.equals("删除"))
		        {
		        	 statement = conn.prepareStatement(sql);
		 	    	 ...
		 	    	 log_caozuo = "在企事业管理干部培训方案里删除了课程:" +course_name+";授课老师：" +course_teacher;
		        ...
		        else if(submit.equals("修改"))
		        {
		 	    	  ...
		 	    	  statement7.executeUpdate(sql7);
		 	    	   ...
		 	    	   log_caozuo = "在企事业管理干部培训方案里修改了课程:" +course_name+";授课老师：" +course_teacher;
