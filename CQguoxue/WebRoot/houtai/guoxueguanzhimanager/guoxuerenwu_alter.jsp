...
<% 		 		 
		 ...
		 Connection conn = null;
   	     String sql1 = "update guoxueguanzhi_guoxuerenwu set title = '"+title+"' where number='"+number+"'";
   	     String sql2 = "update guoxueguanzhi_guoxuerenwu set author = '"+author+"' where number='"+number+"'";
   	     String sql3 = "update guoxueguanzhi_guoxuerenwu set text = '"+text+"' where number='"+number+"'";
   	     String sql4 = "update guoxueguanzhi_guoxuerenwu set tiyao = '"+tiyao+"' where number='"+number+"'";
		 ...
		 String log_caozuo = null;
  	     ...
  	     try
  	     {
				...
				statement1 = conn.prepareStatement(sql1);
		 	    ...
		 	    log_caozuo = "在国学观止版块国学人物栏目修改文章:" + title;
		 	...
		 	//    session.setAttribute("guoxueguanzhi_guoxuerenwu_message","alter_success");
