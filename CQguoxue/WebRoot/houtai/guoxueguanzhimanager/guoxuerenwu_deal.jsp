...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "delete from guoxueguanzhi_guoxuerenwu where number = '" + number +"'";
  	     ...
  	     String sql_title = "select * from guoxueguanzhi_guoxuerenwu where number = '" + number +"'";
		       ...
		       // statement = conn.prepareStatement(sql);
		        ...
		        if(submit.equals("删除"))
		        {
		        	 statement = conn.prepareStatement(sql);
		 	    	 ...
		 	    	 log_caozuo = "在国学观止版块国学人物栏目删除文章:" + title;
		 	    	 ...
		 	    	 session.setAttribute("guoxueguanzhi_guoxuerenwu_message","delete_success");
		 			 response.sendRedirect("guoxuerenwu.jsp");
		        }
		        else if(submit.equals("修改"))
		        {
		        	String sql2 = "select * from guoxueguanzhi_guoxuerenwu where number = '" + number +"'";
...
<html>
  ...
  <body>
  		<div>
  			<a href="houtai/guoxueguanzhimanager/guoxuerenwu.jsp">返回</a>
  		</div>
  			<br><br><br><br>
		...
		<div>
			<h2>修改文章</h2>
			<form  method="post" action="houtai/guoxueguanzhimanager/guoxuerenwu_alter.jsp">
			<% 
				while(rs.next())
				{
			%>
