...
<%  	     
		 ...
		 Connection conn = null;
   	     ...
   	     String sql = "select * from guoxueguanzhi_picture";
  		...
  		<div>
  				...
  				<table border=3>
  						...
  						<tr>
  							...
  							<td>
								<form name='upfileform' method='post' action='houtai/guoxueguanzhimanager/picture_upload.jsp?id=<%=rs.getInt("id")  %>' enctype='multipart/form-data'>
