...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "delete from guoxueguanzhi_jingshiziji where number = '" + number +"'";
  	     ...
  	     String sql_title = "select * from guoxueguanzhi_jingshiziji where number = '" + number +"'";
		        ...
		        if(submit.equals("删除"))
		        {
		        	 statement = conn.prepareStatement(sql);
		 	    	 statement.executeUpdate(sql);
		 	    	   ...
		 	    	   log_caozuo = "在国学观止版块经史子集栏目删除文章:" + title;
		 	    	 ...
		 	    	 session.setAttribute("guoxueguanzhi_jingshiziji_message","delete_success");
		 			 response.sendRedirect("jingshiziji.jsp");
		        }
		        else if(submit.equals("修改"))
		        {
		        	String sql2 = "select * from guoxueguanzhi_jingshiziji where number = '" + number +"'";
...
<html>
  ...
  <body>
  		<div>
  			<a href="houtai/guoxueguanzhimanager/jingshiziji.jsp">返回</a>
  		</div>
  			<br><br><br><br>
		...
		<div>
			<h2>修改文章</h2>
			<form  method="post" action="houtai/guoxueguanzhimanager/jingshiziji_alter.jsp">
			<% 
				while(rs.next())
				{
			%>
