...
<% 		 		 
		 ...
		 Connection conn = null;
   	     String sql1 = "update guoxueguanzhi_mengxue set title = '"+title+"' where number='"+number+"'";
   	     String sql2 = "update guoxueguanzhi_mengxue set author = '"+author+"' where number='"+number+"'";
   	     String sql3 = "update guoxueguanzhi_mengxue set text = '"+text+"' where number='"+number+"'";
   	     String sql4 = "update guoxueguanzhi_mengxue set tiyao = '"+tiyao+"' where number='"+number+"'";
		 ...
		 String log_caozuo = null;
  	     ...
  	     try
  	     {
				...
				statement1 = conn.prepareStatement(sql1);
		 	    ...
		 	    log_caozuo = "在国学观止版块蒙学栏目修改文章:" + title;
		 ...
		 //	    session.setAttribute("guoxueguanzhi_mengxue_message","alter_success");
