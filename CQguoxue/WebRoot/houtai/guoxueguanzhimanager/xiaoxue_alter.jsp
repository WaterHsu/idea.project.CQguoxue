...
<% 		 		 
		 ...
		 Connection conn = null;
   	     String sql1 = "update guoxueguanzhi_xiaoxue set title = '"+title+"' where number='"+number+"'";
   	     String sql2 = "update guoxueguanzhi_xiaoxue set author = '"+author+"' where number='"+number+"'";
   	     String sql3 = "update guoxueguanzhi_xiaoxue set text = '"+text+"' where number='"+number+"'";
   	     String sql4 = "update guoxueguanzhi_xiaoxue set tiyao = '"+tiyao+"' where number='"+number+"'";
		 ...
		 String log_caozuo = null;
  	     ...
  	     try
  	     {
				...
				statement1 = conn.prepareStatement(sql1);
		 	    ...
		 	    log_caozuo = "在国学观止版块小学栏目修改文章:" + title;
				...
				log_statement2.executeUpdate(log_sql2);
		 	    ...
		 	    session.setAttribute("guoxueguanzhi_xiaoxue_message","alter_success");
