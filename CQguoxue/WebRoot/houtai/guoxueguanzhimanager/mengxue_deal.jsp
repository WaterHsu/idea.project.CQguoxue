...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "delete from guoxueguanzhi_mengxue where number = '" + number +"'";
  	     ...
  	     ResultSet rs = null;
  	      ...
  	      String sql_title = "select * from guoxueguanzhi_mengxue where number = '" + number +"'";
		       ...
		       // statement = conn.prepareStatement(sql);
		        ...
		        if(submit.equals("删除"))
		        {
		        	 statement = conn.prepareStatement(sql);
		 	    	 ...
		 	    	 log_caozuo = "在国学观止版块蒙学栏目删除文章:" + title;
		 	    	...
		 	    	// session.setAttribute("guoxueguanzhi_mengxue_message","delete_success");
		 			 response.sendRedirect("mengxue.jsp");
		        }
		        else if(submit.equals("修改"))
		        {
		        	String sql2 = "select * from guoxueguanzhi_mengxue where number = '" + number +"'";
...
<html>
  ...
  <body>
  		...
  		<div>
  			<a href="houtai/guoxueguanzhimanager/mengxue.jsp">返回</a>
  		</div>
  			<br><br><br><br>
		...
		<div>
			<h2>修改文章</h2>
			<form  method="post" action="houtai/guoxueguanzhimanager/mengxue_alter.jsp">
			<% 
				while(rs.next())
				{
			%>
