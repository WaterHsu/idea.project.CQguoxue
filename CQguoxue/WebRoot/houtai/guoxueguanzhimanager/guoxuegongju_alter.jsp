...
<% 		 		 
		 ...
		 Connection conn = null;
   	     String sql1 = "update guoxueguanzhi_guoxuegongju set title = '"+title+"' where number='"+number+"'";
   	     String sql2 = "update guoxueguanzhi_guoxuegongju set author = '"+author+"' where number='"+number+"'";
   	     String sql3 = "update guoxueguanzhi_guoxuegongju set text = '"+text+"' where number='"+number+"'";
   	     String sql4 = "update guoxueguanzhi_guoxuegongju set tiyao = '"+tiyao+"' where number='"+number+"'";
		 ...
		 String log_caozuo = null;
  	     ...
  	     try
  	     {
				...
				statement1 = conn.prepareStatement(sql1);
		 	    ...
		 	    log_caozuo = "在国学观止版块国学工具栏目修改文章:" + title;
				...
				log_statement2.executeUpdate(log_sql2);
		 	    ...
		 	    session.setAttribute("guoxueguanzhi_guoxuegongju_message","alter_success");
