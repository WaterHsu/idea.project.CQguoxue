...
<% 		 		 
		 ...
		 Connection conn = null;
   	     String sql1 = "update guoxueyanjiu_zuixinyanjiu set title = '"+title+"' where number='"+number+"'";
   	     String sql2 = "update guoxueyanjiu_zuixinyanjiu set author = '"+author+"' where number='"+number+"'";
   	     String sql3 = "update guoxueyanjiu_zuixinyanjiu set text = '"+text+"' where number='"+number+"'";
   	     String sql4 = "update guoxueyanjiu_zuixinyanjiu set tiyao = '"+tiyao+"' where number='"+number+"'";
		 ...
		 String log_caozuo = null;
  	     ...
  	     try
  	     {
				...
				statement1 = conn.prepareStatement(sql1);
		 	    ...
		 	    log_caozuo = "在国学研究版块最新研究栏目修改文章:" + title;
		 	 ...
		 	 //   session.setAttribute("guoxueyanjiu_zuixinyanjiu_message","alter_success");
