...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "delete from guoxueyanjiu_haiwaiyanjiu where number = '" + number +"'";
  	     ...
  	     ResultSet rs = null;
  	      ...
  	      String sql_title = "select * from guoxueyanjiu_haiwaiyanjiu where number = '" + number +"'";
		        ...
		        if(submit.equals("删除"))
		        {
		        	 statement = conn.prepareStatement(sql);
		 	    	 statement.executeUpdate(sql);
		 	    	  ...
		 	    	  log_caozuo = "在国学研究版块海外研究栏目删除文章:" + title;
		 	    	...
		 	    	// session.setAttribute("guoxueyanjiu_haiwaiyanjiu_message","delete_success");
		 			 response.sendRedirect("haiwaiyanjiu.jsp");
		        }
		        else if(submit.equals("修改"))
		        {
		        	String sql2 = "select * from guoxueyanjiu_haiwaiyanjiu where number = '" + number +"'";
...
<html>
  ...
  <body>
  		<div>
  			<a href="houtai/guoxueyanjiumanager/haiwaiyanjiu.jsp">返回</a>
  		</div>
  			<br><br><br><br>
		...
		<div>
			<h2>修改文章</h2>
			<form  method="post" action="houtai/guoxueyanjiumanager/haiwaiyanjiu_alter.jsp">
			<% 
				while(rs.next())
				{
			%>
