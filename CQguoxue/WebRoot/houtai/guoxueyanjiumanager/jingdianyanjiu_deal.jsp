...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "delete from guoxueyanjiu_jingdianyanjiu where number = '" + number +"'";
  	     ...
  	     String sql_title = "select * from guoxueyanjiu_jingdianyanjiu where number = '" + number +"'";
		       ...
		       // statement = conn.prepareStatement(sql);
		        ...
		        if(submit.equals("删除"))
		        {
		        	 statement = conn.prepareStatement(sql);
		 	    	 ...
		 	    	 log_caozuo = "在国学研究版块经典研究栏目删除文章:" + title;
		 	    	...
		 	    	// session.setAttribute("guoxueyanjiu_jingdianyanjiu_message","delete_success");
		 			 response.sendRedirect("jingdianyanjiu.jsp");
		        }
		        else if(submit.equals("修改"))
		        {
		        	String sql2 = "select * from guoxueyanjiu_jingdianyanjiu where number = '" + number +"'";
...
<html>
  ...
  <body>
  		<div>
  			<a href="houtai/guoxueyanjiumanager/jingdianyanjiu.jsp">返回</a>
  		</div>
  			<br><br><br><br>
		...
		<div>
			<h2>修改文章</h2>
			<form  method="post" action="houtai/guoxueyanjiumanager/jingdianyanjiu_alter.jsp">
			<% 
				while(rs.next())
				{
			%>
