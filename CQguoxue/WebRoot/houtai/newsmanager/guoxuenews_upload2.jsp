...
<% 		 		 
		 ...
		 Connection conn = null;
   	     String sql1 = "update guoxuenews_guonei set title = '"+title+"' where number='"+number+"'";
   	     String sql2 = "update guoxuenews_guonei set author = '"+author+"' where number='"+number+"'";
   	     String sql3 = "update guoxuenews_guonei set image = '"+newsimage+"' where number='"+number+"'";
   	     String sql4 = "update guoxuenews_guonei set text = '"+text+"' where number='"+number+"'";
		 	    ...
		 	    conn = DriverManager.getConnection(dbUrl, dbUsr, dbPwd);
					...
					statement1 = conn.prepareStatement(sql1);
		 	    	...
		 	    	statement4.executeUpdate(sql4);
		 	    	   ...
		 	    	   log_caozuo = "在国学新闻版块修改国内新闻:" + title;
