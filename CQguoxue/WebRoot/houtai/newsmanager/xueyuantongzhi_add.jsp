...
<% 
		 ...
		 String log_caozuo = null;
  	     ...
  	     try
  	     {
				...
				if(id != 0)
				{
					String sql2 = "update xueyuan_tongzhi set state = '2' where id="+id+"";
				...
				id++;
				String sql3 = "insert into xueyuan_tongzhi (id,number,content,author,time,add_user,kinds,state) values(" +id+ ",'" +number+ "','" +content+ "','" +author+ "','" +time+ "','" +houtai_username+ "','" +kinds+ "','1')";		        		        		        
				
				statement3 = conn.prepareStatement(sql3);
		       	statement3.executeUpdate(sql3);
		       	
		       	
		       	log_caozuo = "在通知版块发布:" + kinds;
