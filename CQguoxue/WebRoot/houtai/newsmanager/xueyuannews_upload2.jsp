...
<% 		 		 
		 ...
		 Connection conn = null;
   	     String sql1 = "update xueyuan_xinwen set title = '"+title+"' where number='"+number+"'";
   	     String sql2 = "update xueyuan_xinwen set author = '"+author+"' where number='"+number+"'";
   	     String sql3 = "update xueyuan_xinwen set image = '"+newsimage+"' where number='"+number+"'";
   	     String sql4 = "update xueyuan_xinwen set text = '"+text+"' where number='"+number+"'";
		 ...
		 String log_caozuo = null;
  	     ...
  	     try
  	     {
				...
				log_statement2.executeUpdate(log_sql2);
		 	    ...
		 	    session.setAttribute("newsmanager_message","alter_success");
