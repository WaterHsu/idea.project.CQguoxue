...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "delete from xueyuan_xinwen where number = '" + number +"'";
   	      String sql_title = "select * from xueyuan_xinwen where number = '" + number +"'";
		       ...
		       // statement = conn.prepareStatement(sql);
		        ...
		        if(submit.equals("删除"))
		        {
					 ...
					 log_statement2.executeUpdate(log_sql2);
		 			 ...
		 			 response.sendRedirect("xueyuannews.jsp");
		        }
		...
		/*        	while(rs.next())
		        	{
		        		out.println("<div><table><tr><td>上传一张在左侧显示的新闻图片：</td><td><form name='upfileform' method='post' action='houtai/newsmanager/uploadpic2.jsp' enctype='multipart/form-data'><input type='file' id='mpic' name='mpic'  size='50' /><br><input type='submit' name='submit' value='上传' /></form></td></tr></table></div>");
		        		out.println("<div><form name='xueyuan_news' method='post' action='houtai/newsmanager/xueyuannews_upload2.jsp'><table>");
...
<html>
  ...
  <body>
  		<div>
  			<a href="houtai/newsmanager/xueyuannews.jsp">返回</a>
  		</div>
  		<br><br><br><br>
		<div>
			<table>
				<tr>
					<td>新闻栏左侧的图片:</td>
					<td>
						<form name="upfileform" method="post" action="houtai/newsmanager/uploadpic2.jsp" enctype="multipart/form-data">
		  ...
		  <div>
		  		<form name="xueyuan_news" method="post" action="houtai/newsmanager/xueyuannews_upload2.jsp">
		  			<table>
		  				<% 
		  					while(rs.next())
		  					{
		  				%>
		  					<tr>
		  						<td>新闻标题:</td>
		  						<td>
		  							<input type="text" id="title" name="title" value="<%=rs.getString("title") %> " style="width: 300px;"  />
		  						</td>
		  					</tr>
		  					<tr>
		  						<td>作者:</td>
		  					...
		  					<tr>
		  						<td>图片:</td>
		  						<td>
		  							<input name="newsimage" value="<%=rs.getString("image") %>" style="width: 300px;" readonly />
		  						</td>
		  					</tr>
		  					<tr>
		  						<td>新闻内容:</td>
