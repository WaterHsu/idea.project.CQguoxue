...
<% 
		 ...
		 String log_caozuo = null;
  	     ...
  	     try
  	     {
		        ...
		        String sql2 = "insert into xueyuan_xinwen (id,number,author,time,title,image,webaddress,text,add_user,visits) values(" +id+ ",'" +number+ "','" +author+ "','" +time+ "','" +title+ "','" +newsimage+ "','" +webaddress+ "','" +text+ "','" +houtai_username+ "',0)";
	
  	            statement2 = conn.prepareStatement(sql2);
		       	statement2.executeUpdate(sql2);
		       	
		       	log_caozuo = "在学院新闻版块发布新闻:" + title;
