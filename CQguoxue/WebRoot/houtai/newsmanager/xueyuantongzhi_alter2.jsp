...
<% 
		 ...
		 String author = request.getParameter("author").toString();
  	     ...
  	     String kinds = request.getParameter("kinds").toString();
		 ...
		 Connection conn = null;
   	     String sql1 = "update xueyuan_tongzhi set kinds = '"+kinds+"'  where number = '" + number +"'";
   	     String sql2 = "update xueyuan_tongzhi set author = '"+author+"' where number='"+number+"'";
   	     String sql3 = "update xueyuan_tongzhi set content = '"+content+"' where number='"+number+"'";
		 ...
		 String log_caozuo = null;
  	     ...
  	     try
  	     {
		 	    ...
		 	    while(rs_title.next())
		 	    {
		 	    	 log_kinds = rs_title.getString("kinds");
		 	    	 log_time = rs_title.getString("time");
		 	    }
		        ...
		        statement1 = conn.prepareStatement(sql1);
		 	    ...
		 	    log_caozuo = "在通知版块删除在" +log_time+ "的时候发布的" + log_kinds;
