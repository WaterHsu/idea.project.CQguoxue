...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "delete from guoxuetuiguang_xuexiaotuiguang where number = '" + number +"'";
  	     ...
  	     ResultSet rs = null;
  	      ...
  	      String sql_title = "select * from guoxuetuiguang_xuexiaotuiguang where number = '" + number +"'";
		       ...
		       // statement = conn.prepareStatement(sql);
		        ...
		        if(submit.equals("删除"))
		        {
		        	 statement = conn.prepareStatement(sql);
		 	    	 ...
		 	    	 log_caozuo = "在国学推广版块学校推广栏目删除文章:" + title;
		 	    ...
		 	    //	 session.setAttribute("guoxuetuiguang_xuexiaotuiguang_message","delete_success");
		 			 response.sendRedirect("xuexiaotuiguang.jsp");
		        }
		        else if(submit.equals("修改"))
		        {
		        	String sql2 = "select * from guoxuetuiguang_xuexiaotuiguang where number = '" + number +"'";
...
<html>
  ...
  <body>
  	<div>
  			<a href="houtai/guoxuetuiguangmanager/xuexiaotuiguang.jsp">返回</a>
  		</div>
  			<br><br><br><br>
		...
		<div>
			<h2>修改文章</h2>
			<form  method="post" action="houtai/guoxuetuiguangmanager/xuexiaotuiguang_alter.jsp">
			<% 
				while(rs.next())
				{
			%>
