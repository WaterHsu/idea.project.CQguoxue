...
<% 		 		 
		 ...
		 Connection conn = null;
   	     String sql1 = "update guoxuetuiguang_shequtuiguang set title = '"+title+"' where number='"+number+"'";
   	     String sql2 = "update guoxuetuiguang_shequtuiguang set author = '"+author+"' where number='"+number+"'";
   	     String sql3 = "update guoxuetuiguang_shequtuiguang set text = '"+text+"' where number='"+number+"'";
   	     String sql4 = "update guoxuetuiguang_shequtuiguang set tiyao = '"+tiyao+"' where number='"+number+"'";
		 ...
		 String log_caozuo = null;
  	     ...
  	     try
  	     {
				...
				statement1 = conn.prepareStatement(sql1);
		 	    ...
		 	    log_caozuo = "在国学推广版块推广社区推广栏目修改文章:" + title;
		 	 ...
		 	 //   session.setAttribute("guoxuetuiguang_shequtuiguang_message","alter_success");
