...
<%  	     
		 ...
		 Connection conn = null;
   	     ...
   	     String sql = "select * from guoxuetuiguang_picture";
  		...
  		<div>
  				...
  				<table border=3>
  						...
  						<tr>
  							...
  							<td>
								<form name='upfileform' method='post' action='houtai/guoxuetuiguangmanager/picture_upload.jsp?id=<%=rs.getInt("id")  %>' enctype='multipart/form-data'>
