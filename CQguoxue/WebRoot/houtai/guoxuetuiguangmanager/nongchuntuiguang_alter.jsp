...
<% 		 		 
		 ...
		 Connection conn = null;
   	     String sql1 = "update guoxuetuiguang_nongchuntuiguang set title = '"+title+"' where number='"+number+"'";
   	     String sql2 = "update guoxuetuiguang_nongchuntuiguang set author = '"+author+"' where number='"+number+"'";
   	     String sql3 = "update guoxuetuiguang_nongchuntuiguang set text = '"+text+"' where number='"+number+"'";
   	     String sql4 = "update guoxuetuiguang_nongchuntuiguang set tiyao = '"+tiyao+"' where number='"+number+"'";
		 ...
		 String log_caozuo = null;
  	     ...
  	     try
  	     {
				...
				statement1 = conn.prepareStatement(sql1);
		 	    ...
		 	    log_caozuo = "在国学推广版块农村推广栏目修改文章:" + title;
		 	   ...
		 	   // session.setAttribute("guoxuetuiguang_nongchuntuiguang_message","alter_success");
