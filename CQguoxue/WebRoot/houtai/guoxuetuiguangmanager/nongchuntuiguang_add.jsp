...
<% 
		 ...
		 String log_caozuo = null;
  	     ...
  	     try
  	     {
		        ...
		        String sql2 = "insert into guoxuetuiguang_nongchuntuiguang (id,number,author,time_yearmonthday,time_hourminute,title,text,add_user,visits,tiyao) values(" +id+ ",'" +number+ "','" +author+ "','" +time_yearmonthday+ "','" +time_hourminute+ "','" +title+ "','" +text+ "','" +houtai_username+ "',0,'" +tiyao+ "')";
	
  	            statement2 = conn.prepareStatement(sql2);
		       	statement2.executeUpdate(sql2);
		       	
		       	
		       	log_caozuo = "在国学推广版块农村推广栏目发布文章:" + title;
