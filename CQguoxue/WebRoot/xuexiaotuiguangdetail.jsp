...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "select * from guoxuetuiguang_xuexiaotuiguang where number='" +number+ "'";
  	     ...
  	     try
  	     {
		        ...
		        if(session.getAttribute(number) == null)
		        {
		        	...
		        	visits2 = visits;
		        	visits2++;
		        	String sql1 = "update guoxuetuiguang_xuexiaotuiguang set visits = "+visits2+" where number='"+number+"'";
...
<body>
		<div id="container" class="sub-container"> 
                ...
                <div id="pagebody">
                		<div id="mainbody"> 
                        	<div>当前位置: <a href="chongqingguoxue.jsp">首页</a> > <a href="xuexiaotuiguang.jsp">学校推广</a> > 正文</div>
                            <div>
