...
<body>
		<div id="container" class="sub-container"> 
                ...
                <div id="pagebody">
                		<div id="mainbody"> 
                        	<div>当前位置: <a href="chongqingguoxue.jsp">首页</a> > 通知</div>
                            <div id="table_list">
                            		<h2>通知列表</h2>
                            		<table style="text-align:center; line-height:30px; align:center;margin:0px auto;">
                            			...
                            			%>
                            			<tr>
                            				<td><a href="xueyuan_tongzhidetail.jsp?id=<%=rs.getString("number")%>"><%=rs.getString("kinds") %></a></td>
                            		...
                            		<% 
                            			...
                            			{
                            		%>
                            		<a href="xueyuan_tongzhi.jsp?page=<%=intPage-1%>">上一页</a>
                            		<% 
                            			}
                            			else if(intPage == 1)
                            			{
                            		...
                            		<% 
                            			...
                            			{
                            		%>
                            		<a href="xueyuantongzhi.jsp?page=<%=intPage+1%>">下一页</a>
                            		<% 
                            			}
