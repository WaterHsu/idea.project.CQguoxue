...
<% 
		 ...
		 Connection conn = null;
   	     String sql = "select * from xueyuan_tongzhi where number='" +number+ "'";
...
<body>
		<div id="container" class="sub-container"> 
                ...
                <div id="pagebody">
                		<div id="mainbody"> 
                        	<div>当前位置: <a href="chongqingguoxue.jsp">首页</a> > <a href="xueyuan_tongzhi.jsp">通知</a> > 正文</div>
                            <div>
